...
const int RivalRoute22EncounterOverworldFlowState::FLOW_TRIGGER_TILE_COL = 7;
const int RivalRoute22EncounterOverworldFlowState::FLOW_TRIGGER_TILE_ROW = 4;
...
void RivalRoute22EncounterOverworldFlowState::VUpdate(const float)
{
    switch (mEventState)
    {
...
void RivalRoute22EncounterOverworldFlowState::UpdateIntroDialog()
{    
...
void RivalRoute22EncounterOverworldFlowState::UpdateMovingToCounter()
{
...
void RivalRoute22EncounterOverworldFlowState::UpdateEndDialog()
{    
    if (GetActiveTextboxEntityId(mWorld) == ecs::NULL_ENTITY_ID)
    {
...
void RivalRoute22EncounterOverworldFlowState::CreateScriptedPath()
{
