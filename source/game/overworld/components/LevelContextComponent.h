...
#ifndef LevelContextComponent_h
#define LevelContextComponent_h
...
class LevelContextComponent final: public ecs::IComponent
{
public:    
     StringId mLevelName;
