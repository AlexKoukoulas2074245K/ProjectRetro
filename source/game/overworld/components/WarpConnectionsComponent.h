...
#ifndef WarpConnectionsComponent_h
#define WarpConnectionsComponent_h
...
class WarpConnectionsComponent final: public ecs::IComponent
{
public:
...
#endif /* WarpConnectionsComponent_h */
