...
void App::DummyInitialization()
{
    ...
    const auto levelEntityId  = LoadAndCreateLevelByName(StringId("in_viridian_school"), mWorld);
    ...
    CreatePlayerOverworldSprite(levelEntityId, Direction::SOUTH, 6, 8, mWorld);
