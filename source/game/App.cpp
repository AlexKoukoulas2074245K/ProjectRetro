...
void App::DummyInitialization()
{
    ...
    playerStateComponent->mPlayerPokemonRoster.push_back(CreatePokemon(StringId("CATERPIE"), 6, false, mWorld));    
    ...
    CreatePlayerOverworldSprite(levelEntityId, Direction::SOUTH, 16, 13, mWorld);
